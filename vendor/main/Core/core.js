...
MUI.append({
	'options': {
		...
		path: {
			...
			source:		'{root}vendor/main/',			// Path to MochaUI source JavaScript
			themes:		'{root}public/theme/default/Themes/'		// Path to MochaUI Themes
		},

		pluginGroups: {
			'controls':{path:'{root}vendor/main/Controls/',singularName:'control'},
			'plugins':{path:'{root}public/js/Plugins/',singularName:'plugin'}
		},
